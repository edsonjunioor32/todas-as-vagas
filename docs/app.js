(() => {
  ...
  const SOURCE_LABELS = {
    ...
    petlove: 'Petlove',
    economart: 'Economart',
    savegnago: 'Grupo Savegnago',
    grupoluck: 'Grupo Luck',
    grupokoch: 'Grupo Koch',
    atakarejo: 'Atakarejo',
    bravante: 'Grupo Bravante',
    supermercadosvianense: 'Supermercados Vianense',
    recibom: 'Recibom',
    vagasdiaadia: 'Atacadão Dia a Dia',
    grupovanguarda: 'Grupo Vanguarda',
    tirol: 'Laticínios Tirol',
    novomateus: 'Novo Mateus',
    tagguirh: 'Taggui RH',
    ...
    grupolev: 'Grupo Lev',
    fiotec: 'Fiotec',
    pessoaepessoa: 'Pessoa e Pessoa',
    grupokothe: 'Grupo Kothe',
    jb3investimentos: 'JB3 Investimentos',
    osklen: 'Osklen',
    finayatech: 'Finaya Tech',
    yellowipe: 'YellowIpe',
    somosglobal: 'Somos Global',
    revemar: 'Revemar',
    insper: 'Insper',
    guaranamineiro: 'Guaraná Mineiro',
    tivit: 'TIVIT',
    overlabs: 'Overlabs',
